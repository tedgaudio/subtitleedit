...
namespace Nikse.SubtitleEdit.Forms.Options
{
    public sealed partial class Settings : PositionAndSizeForm
    {
        ...
        private void MakeShortcutsTreeView(LanguageStructure.Settings language)
        {
            ...
            AddNode(listViewAndTextBoxNode, "Set new on/off screen", nameof(Configuration.Settings.Shortcuts.MainListViewSetNewOnOffScreen));
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "1"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen1), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "2"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen2), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "3"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen3), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "4"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen4), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "5"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen5), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "6"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen6), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "7"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen7), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "8"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen8), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "9"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen9), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set on/off screen {0}", "10"), nameof(Configuration.Settings.Shortcuts.MainListViewSetOnOffScreen10), true);
            AddNode(listViewAndTextBoxNode, "Set new diegetic", nameof(Configuration.Settings.Shortcuts.MainListViewSetNewDiegetic));
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "1"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic1), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "2"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic2), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "3"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic3), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "4"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic4), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "5"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic5), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "6"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic6), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "7"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic7), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "8"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic8), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "9"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic9), true);
            AddNode(listViewAndTextBoxNode, string.Format("Set diegetic {0}", "10"), nameof(Configuration.Settings.Shortcuts.MainListViewSetDiegetic10), true);
