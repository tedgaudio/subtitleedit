...
namespace Nikse.SubtitleEdit.Core.Settings
{
    ...
    public class Settings
    {
        ...
        public static Settings CustomDeserialize(string fileName)
        {
            ...
            if (subNode != null)
            {
                settings.Tools.ListViewShowColumnNotes = Convert.ToBoolean(subNode.InnerText, CultureInfo.InvariantCulture);
            }
        ...
        internal static void ReadShortcuts(XmlDocument doc, Shortcuts shortcuts)
        {
            ...
            if (node != null)
            {
                ...
                if (subNode != null)
                {
                    shortcuts.MainListViewSetNewNotes = subNode.InnerText;
                }
